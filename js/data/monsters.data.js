...
export const MONSTERS = {
  ...
  boss_mossback: {
    ...
    zone: 'whisperwood',
    type: 'aggressive',
    statusEffectOnHit: { type: 'bleed', chance: 0.25, stacks: 1 },
    isBoss: true,
    levelMin: 10,
    levelMax: 10,
    baseHealth: 750,
  ...
  dustwind_snake: {
    ...
    type: 'swift',
    statusImmunities: ['poison'],
    statusEffectOnHit: { type: 'poison', chance: 0.30, stacks: 1 },
    isBoss: false,
    levelMin: 11,
    levelMax: 15,
    baseHealth: 700,
  ...
  dustwind_devil: {
    ...
    type: 'swift',
    damageType: 'magic',
    statusEffectOnHit: { type: 'slow', chance: 0.20 },
    isBoss: false,
    levelMin: 11,
    levelMax: 15,
    baseHealth: 720,
  ...
  dustwind_bandit: {
    ...
    zone: 'dustwind',
    type: 'aggressive',
    statusEffectOnHit: { type: 'bleed', chance: 0.20, stacks: 1 },
    isBoss: false,
    levelMin: 13,
    levelMax: 17,
    baseHealth: 900,
  ...
  boss_redfang: {
    ...
    zone: 'dustwind',
    type: 'aggressive',
    statusEffectOnHit: { type: 'bleed', chance: 0.35, stacks: 2 },
    isBoss: true,
    levelMin: 20,
    levelMax: 20,
    baseHealth: 3000,
  ...
  shadowmire_wisp: {
    ...
    magicResist: 15,
    statusImmunities: ['poison'],
    statusEffectOnHit: { type: 'burn', chance: 0.20 },
    isBoss: false,
    levelMin: 21,
    levelMax: 26,
    baseHealth: 1650,
  ...
  shadowmire_leech: {
    ...
    zone: 'shadowmire',
    type: 'swift',
    statusEffectOnHit: { type: 'poison', chance: 0.25, stacks: 1 },
    isBoss: false,
    levelMin: 23,
    levelMax: 28,
    baseHealth: 2000,
  ...
  shadowmire_serpent: {
    ...
    type: 'aggressive',
    statusImmunities: ['poison'],
    statusEffectOnHit: { type: 'poison', chance: 0.35, stacks: 1 },
    isBoss: false,
    levelMin: 27,
    levelMax: 30,
    baseHealth: 3200,
  ...
  boss_mire_mother: {
    ...
    damageType: 'magic',
    statusImmunities: ['poison'],
    statusEffectOnHit: { type: 'poison', chance: 0.40, stacks: 2 },
    isBoss: true,
    levelMin: 30,
    levelMax: 30,
    baseHealth: 8000,
  ...
  ironhold_drake: {
    ...
    statusEffectOnHit: { type: 'burn', chance: 0.30 },
    isBoss: false,
    levelMin: 36,
    levelMax: 43,
    baseHealth: 5200,
  ...
  boss_grimstone: {
    ...
    statusImmunities: ['poison', 'slow', 'freeze'],
    statusEffectOnHit: { type: 'bleed', chance: 0.30, stacks: 1 },
    isBoss: true,
    levelMin: 45,
    levelMax: 45,
    baseHealth: 22000,
  ...
  emberfell_hound: {
    ...
    damageType: 'magic',
    statusImmunities: ['burn'],
    statusEffectOnHit: { type: 'burn', chance: 0.25 },
    isBoss: false,
    levelMin: 45,
    levelMax: 52,
    baseHealth: 6735,
  ...
  emberfell_drake: {
    ...
    damageType: 'magic',
    statusImmunities: ['burn'],
    statusEffectOnHit: { type: 'burn', chance: 0.35 },
    isBoss: false,
    levelMin: 55,
    levelMax: 60,
    baseHealth: 14500,
  ...
  boss_pyrax: {
    ...
    damageType: 'magic',
    statusImmunities: ['burn', 'slow'],
    statusEffectOnHit: { type: 'burn', chance: 0.40 },
    isBoss: true,
    levelMin: 60,
    levelMax: 60,
    baseHealth: 55000,
  ...
  frostpeak_sprite: {
    ...
    damageType: 'magic',
    statusImmunities: ['slow', 'freeze'],
    statusEffectOnHit: { type: 'freeze', chance: 0.15 },
    isBoss: false,
    levelMin: 60,
    levelMax: 66,
    baseHealth: 14460,
  ...
  frostpeak_yeti: {
    ...
    type: 'armored+aggressive',
    statusImmunities: ['slow', 'freeze'],
    statusEffectOnHit: { type: 'slow', chance: 0.25 },
    isBoss: false,
    levelMin: 60,
    levelMax: 67,
    baseHealth: 15500,
  ...
  frostpeak_wyrm: {
    ...
    damageType: 'magic',
    statusImmunities: ['slow', 'freeze'],
    statusEffectOnHit: { type: 'freeze', chance: 0.20 },
    isBoss: false,
    levelMin: 70,
    levelMax: 75,
    baseHealth: 32000,
  ...
  boss_glacielle: {
    ...
    damageType: 'magic',
    statusImmunities: ['slow', 'freeze'],
    statusEffectOnHit: { type: 'freeze', chance: 0.25 },
    isBoss: true,
    levelMin: 75,
    levelMax: 75,
    baseHealth: 140000,

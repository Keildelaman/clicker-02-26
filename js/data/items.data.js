...
export const ITEMS = {
  ...
  weapon_shadowmire_uncommon_01: {
    ...
    zone: 'shadowmire',
    requiredLevel: 25,
    stats: { attack: 120, critChance: 0.04 },
    buyPrice: 3750,
    sellPrice: 937,
    shopAvailable: true,
    dropOnly: false,
  ...
  weapon_shadowmire_rare_01: {
    ...
    zone: 'shadowmire',
    requiredLevel: 33,
    stats: { attack: 175, critChance: 0.05, critDamage: 0.3 },
    buyPrice: 9000,
    sellPrice: 2250,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_ironhold_uncommon_01: {
    ...
    zone: 'ironhold',
    requiredLevel: 38,
    stats: { attack: 280, critChance: 0.05, critDamage: 0.2 },
    buyPrice: 11250,
    sellPrice: 2812,
    shopAvailable: true,
    dropOnly: false,
  ...
  weapon_emberfell_uncommon_01: {
    ...
    zone: 'emberfell',
    requiredLevel: 53,
    stats: { attack: 630, critChance: 0.06, critDamage: 0.3 },
    buyPrice: 30000,
    sellPrice: 7500,
    shopAvailable: true,
    dropOnly: false,
  ...
  weapon_emberfell_rare_01: {
    ...
    zone: 'emberfell',
    requiredLevel: 63,
    stats: { attack: 900, critChance: 0.07, critDamage: 0.5, armorPen: 20 },
    buyPrice: 72000,
    sellPrice: 18000,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_frostpeak_uncommon_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 68,
    stats: { attack: 1400, critChance: 0.07, critDamage: 0.4 },
    buyPrice: 75000,
    sellPrice: 18750,
    shopAvailable: true,
    dropOnly: false,
  ...
  weapon_frostpeak_rare_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 78,
    stats: { attack: 2000, critChance: 0.08, critDamage: 0.6, armorPen: 30 },
    buyPrice: 180000,
    sellPrice: 45000,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_voidrift_rare_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 90,
    stats: { attack: 4400, critChance: 0.09, critDamage: 0.7, armorPen: 35 },
    buyPrice: 450000,
    sellPrice: 112500,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_voidrift_epic_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 95,
    stats: { attack: 6000, critChance: 0.10, critDamage: 0.9, armorPen: 45 },
    buyPrice: 1125000,
    sellPrice: 281250,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_voidrift_legendary_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 100,
    stats: { attack: 8000, critChance: 0.12, critDamage: 1.0, armorPen: 100 },
    buyPrice: 3750000,
    sellPrice: 937500,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_shadowmire_epic_01: {
    ...
    zone: 'shadowmire',
    requiredLevel: 27,
    stats: { attack: 155, critChance: 0.06, critDamage: 0.35, armorPen: 8 },
    buyPrice: 22500,
    sellPrice: 5625,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_emberfell_epic_01: {
    ...
    zone: 'emberfell',
    requiredLevel: 55,
    stats: { attack: 810, critChance: 0.08, critDamage: 0.55, armorPen: 30 },
    buyPrice: 180000,
    sellPrice: 45000,
    shopAvailable: false,
    dropOnly: true,
  ...
  weapon_frostpeak_legendary_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 73,
    stats: { attack: 1800, critChance: 0.10, critDamage: 0.75, armorPen: 40, skillCooldown: 0.15 },
    buyPrice: 1500000,
    sellPrice: 375000,
    shopAvailable: false,
    dropOnly: true,

...
export const ITEMS = {
  ...
  armor_whisperwood_common_01: {
    ...
    zone: 'whisperwood',
    requiredLevel: 2,
    stats: { damageReduction: 0.05, maxHP: 10, armor: 10 },
    buyPrice: 225,
    sellPrice: 56,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_whisperwood_uncommon_01: {
    ...
    zone: 'whisperwood',
    requiredLevel: 5,
    stats: { damageReduction: 0.08, maxHP: 25, hpRegen: 0.005, armor: 15 },
    buyPrice: 450,
    sellPrice: 112,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_whisperwood_rare_01: {
    ...
    zone: 'whisperwood',
    requiredLevel: 10,
    stats: { damageReduction: 0.12, maxHP: 50, hpRegen: 0.01, armor: 20, magicResist: 5 },
    buyPrice: 1200,
    sellPrice: 300,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_dustwind_common_01: {
    ...
    zone: 'dustwind',
    requiredLevel: 10,
    stats: { damageReduction: 0.08, maxHP: 30, armor: 18 },
    buyPrice: 750,
    sellPrice: 187,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_dustwind_uncommon_01: {
    ...
    zone: 'dustwind',
    requiredLevel: 14,
    stats: { damageReduction: 0.12, maxHP: 60, hpRegen: 0.008, armor: 25 },
    buyPrice: 1800,
    sellPrice: 450,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_dustwind_rare_01: {
    ...
    zone: 'dustwind',
    requiredLevel: 22,
    stats: { damageReduction: 0.15, maxHP: 100, hpRegen: 0.01, critChance: 0.03, armor: 35, magicResist: 8 },
    buyPrice: 4500,
    sellPrice: 1125,
    shopAvailable: false,
    dropOnly: true,
  ...
  accessory_shadowmire_rare_01: {
    ...
    zone: 'shadowmire',
    requiredLevel: 33,
    stats: { maxHP: 50, hpRegen: 0.005, damageReduction: 0.08, magicResist: 15 },
    buyPrice: 9000,
    sellPrice: 2250,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_shadowmire_common_01: {
    ...
    zone: 'shadowmire',
    requiredLevel: 20,
    stats: { damageReduction: 0.10, maxHP: 60, armor: 20, magicResist: 15 },
    buyPrice: 1800,
    sellPrice: 450,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_shadowmire_uncommon_01: {
    ...
    zone: 'shadowmire',
    requiredLevel: 25,
    stats: { damageReduction: 0.14, maxHP: 100, hpRegen: 0.01, armor: 25, magicResist: 20 },
    buyPrice: 4500,
    sellPrice: 1125,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_shadowmire_rare_01: {
    ...
    zone: 'shadowmire',
    requiredLevel: 33,
    stats: { damageReduction: 0.18, maxHP: 150, hpRegen: 0.015, armor: 35, magicResist: 25 },
    buyPrice: 12000,
    sellPrice: 3000,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_ironhold_common_01: {
    ...
    zone: 'ironhold',
    requiredLevel: 30,
    stats: { damageReduction: 0.12, maxHP: 100, armor: 40, magicResist: 10 },
    buyPrice: 5400,
    sellPrice: 1350,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_ironhold_uncommon_01: {
    ...
    zone: 'ironhold',
    requiredLevel: 38,
    stats: { damageReduction: 0.16, maxHP: 180, hpRegen: 0.012, armor: 55, magicResist: 15 },
    buyPrice: 13500,
    sellPrice: 3375,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_ironhold_rare_01: {
    ...
    zone: 'ironhold',
    requiredLevel: 48,
    stats: { damageReduction: 0.22, maxHP: 280, hpRegen: 0.015, armor: 75, magicResist: 20 },
    buyPrice: 36000,
    sellPrice: 9000,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_emberfell_common_01: {
    ...
    zone: 'emberfell',
    requiredLevel: 45,
    stats: { damageReduction: 0.14, maxHP: 150, armor: 20, magicResist: 45 },
    buyPrice: 15000,
    sellPrice: 3750,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_emberfell_uncommon_01: {
    ...
    zone: 'emberfell',
    requiredLevel: 52,
    stats: { damageReduction: 0.18, maxHP: 250, hpRegen: 0.015, armor: 25, magicResist: 60 },
    buyPrice: 36000,
    sellPrice: 9000,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_emberfell_rare_01: {
    ...
    zone: 'emberfell',
    requiredLevel: 63,
    stats: { damageReduction: 0.24, maxHP: 380, hpRegen: 0.018, critChance: 0.05, armor: 30, magicResist: 80 },
    buyPrice: 90000,
    sellPrice: 22500,
    shopAvailable: false,
    dropOnly: true,
  ...
  accessory_frostpeak_rare_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 78,
    stats: { maxHP: 200, damageReduction: 0.15, hpRegen: 0.015, magicResist: 60 },
    buyPrice: 180000,
    sellPrice: 45000,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_frostpeak_common_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 60,
    stats: { damageReduction: 0.16, maxHP: 220, armor: 25, magicResist: 55 },
    buyPrice: 36000,
    sellPrice: 9000,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_frostpeak_uncommon_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 68,
    stats: { damageReduction: 0.20, maxHP: 350, hpRegen: 0.018, armor: 35, magicResist: 75 },
    buyPrice: 90000,
    sellPrice: 22500,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_frostpeak_rare_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 78,
    stats: { damageReduction: 0.26, maxHP: 500, hpRegen: 0.020, skillCooldown: 0.10, armor: 40, magicResist: 100 },
    buyPrice: 225000,
    sellPrice: 56250,
    shopAvailable: false,
    dropOnly: true,
  ...
  accessory_voidrift_rare_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 88,
    stats: { goldFind: 0.30, xpBonus: 0.20, damageReduction: 0.10, magicResist: 40 },
    buyPrice: 450000,
    sellPrice: 112500,
    shopAvailable: false,
    dropOnly: true,
  ...
  accessory_voidrift_legendary_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 100,
    stats: { maxHP: 500, damageReduction: 0.20, hpRegen: 0.02, energyGain: 0.25, critChance: 0.10, magicPower: 500, magicPen: 0.15 },
    buyPrice: 3750000,
    sellPrice: 937500,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_voidrift_common_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 75,
    stats: { damageReduction: 0.18, maxHP: 320, armor: 50, magicResist: 50 },
    buyPrice: 90000,
    sellPrice: 22500,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_voidrift_uncommon_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 85,
    stats: { damageReduction: 0.22, maxHP: 480, hpRegen: 0.020, armor: 70, magicResist: 70 },
    buyPrice: 225000,
    sellPrice: 56250,
    shopAvailable: true,
    dropOnly: false,
  ...
  armor_voidrift_rare_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 92,
    stats: { damageReduction: 0.28, maxHP: 650, hpRegen: 0.022, skillCooldown: 0.12, armor: 90, magicResist: 90 },
    buyPrice: 540000,
    sellPrice: 135000,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_voidrift_legendary_01: {
    ...
    zone: 'voidrift',
    requiredLevel: 100,
    stats: { damageReduction: 0.35, maxHP: 1000, hpRegen: 0.025, skillCooldown: 0.20, skillEnergyCost: 0.15, armor: 120, magicResist: 120 },
    buyPrice: 4500000,
    sellPrice: 1125000,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_ironhold_epic_01: {
    ...
    zone: 'ironhold',
    requiredLevel: 42,
    stats: { damageReduction: 0.28, maxHP: 400, hpRegen: 0.018, armor: 80, magicResist: 20 },
    buyPrice: 67500,
    sellPrice: 16875,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_emberfell_epic_01: {
    ...
    zone: 'emberfell',
    requiredLevel: 55,
    stats: { damageReduction: 0.28, maxHP: 450, hpRegen: 0.020, critChance: 0.06, armor: 30, magicResist: 85 },
    buyPrice: 180000,
    sellPrice: 45000,
    shopAvailable: false,
    dropOnly: true,
  ...
  armor_frostpeak_legendary_01: {
    ...
    zone: 'frostpeak',
    requiredLevel: 73,
    stats: { damageReduction: 0.32, maxHP: 750, hpRegen: 0.025, skillEnergyCost: 0.20, armor: 45, magicResist: 110 },
    buyPrice: 1500000,
    sellPrice: 375000,
    shopAvailable: false,
    dropOnly: true,
